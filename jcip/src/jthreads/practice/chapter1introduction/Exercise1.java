package jthreads.practice.chapter1introduction;

import java.io.IOException;

/**
 * blocking I/O, old I/O ?
 *
...
public class Exercise1 {
    public static void main(String[] args) {
        ...
        try {
            while (-1 != (ascii = System.in.read())) {
                System.out.println((char) ascii + "'s ascii code is : " + ascii);

                System.out.println("please continue input:\n");
            }
